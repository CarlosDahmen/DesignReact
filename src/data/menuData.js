...
export const tooltipData = [
  { title: "Profile", icon: "/images/icons/account.svg", link: "/account" },
  { title: "Settings", icon: "/images/icons/account.svg", link: "/account" },
  { title: "Sign Out", icon: "/images/icons/account.svg", link: "/account" },
]
